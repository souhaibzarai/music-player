...
export const MusicPlayer = () => {
  const { currentTrack, formatTime, currentTime, duration, setDuration, setCurrentTime, prevTrack, nextTrack, isPlaying, play, pause, volume, setVolume } = useMusic();
  ...
  return (
    <div className='box'>
      ...
      <div className="volume-container">
        ...
        <input type="range" min={0} max={1} step={.1} value={volume} onChange={handleVolumeChange} />
      </div>
    </div>
  )
}
